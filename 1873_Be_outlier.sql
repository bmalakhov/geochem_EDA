...
t.element_ref=37 
ORDER BY t.mant DESC select t1.id, t1.mant,t1.expo, t5.detection_limit, t5.detection_limit_expo,t6.name from data t1, elements t2, samples t3, holes t4 , detection_limits t5, geochem_methods t6
